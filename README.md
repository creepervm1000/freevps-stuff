...
# 4 the no cc trials
now i have 2 here. 1: cloudsigma, they offer a 7day trial. any os, SLOW VNC you should use rdp or ssh after installing. the net is limited to 5gb transfer only (this is not speed) on the trial. needs a valid phone number which you can get from quackr or just enter a real one. also you need a business email for this (aka a email with a non consumer prefix like gmail.com, you could use any demo that allows u to make a mailbox) (all ports open + dynamic ip)
